        ...
        catBtns.forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (carouselViewportWrapper) {
                    ...
                    if (!isComingSoon) {
                        // Switch between Classic, Premium, and Noodles based on category
                        const catText = e.target.textContent.trim().toUpperCase();
                        if (catText === 'PREMIUM') carouselIndex = 1;
                        else if (catText === 'NOODLES') carouselIndex = 2;
