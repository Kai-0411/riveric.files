...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (productsCarousel) {
        ...
        const productData = [
            ...
            {
                title: 'riveric 200ml (Classic)',
                price: 'Case of 24 Bottles',
                features: ['• Mineral-Rich Water', '• Premium Quality', '• Ideal for events']
            },
            {
                title: 'riveric 500ml (Classic)',
                price: 'Case of 12 Bottles',
                features: ['• Pure Hydration', '• Perfect for active lifestyle', '• Easily portable']
            },
            {
                title: 'riveric 1 Litre (Classic)',
                price: 'Case of 12 Bottles',
                features: ['• Daily Hydration', '• Great for home & office', '• Eco-conscious packaging']
            },
            {
                title: 'riveric 300ml',
                price: 'Case of 24 Bottles',
                features: ['• Mini Size', '• Easy to carry', '• Party pack']
            },
            {
                title: 'riveric 300ml',
                price: 'Case of 24 Bottles',
            ...
            {
                title: 'riveric Cup Noodle',
                price: 'Quick Snack',
                features: ['• Ready in Minutes', '• On-the-Go', '• Delicious Taste']
            },
            {
                title: 'riveric Standard Noodle',
                price: 'Satisfying Portion',
                features: ['• Authentic Recipe', '• Rich Flavor', '• Perfect Meal']
            },
            {
                title: 'riveric Family Pack Noodle',
                price: 'For Everyone',
                features: ['• Shareable Size', '• Extra Spices', '• Value Pack']
            },
            {
                title: 'riveric Soda 500ml',
                price: 'Personal Size',
                features: ['• Long-lasting Fizz', '• Refreshing', '• Great Value']
            },
            {
                title: 'riveric Soda 500ml',
                price: 'Personal Size',
        ...
        // Remember what volume was selected for each slide
        let volumeStates = {
            0: 1, 1: 1, 2: 0, 3: 2, 4: 1, 5: 1
        };
        ...
        const updateProductText = (instant = false) => {
            if (!instant) {
                // Restore the state for this slide
                volumeIndex = volumeStates[carouselIndex];
            }
            ...
            const applyData = () => {
                ...
                if (activeVolBtns.length === 3) {
                    if (carouselIndex === 2) {
                        activeVolBtns[0].textContent = '300 ML';
                        activeVolBtns[0].style.display = 'inline-block';
                        activeVolBtns[1].style.display = 'none';
                        activeVolBtns[2].style.display = 'none';
                        volumeIndex = 0; // Force active state onto the left button
                    } else if (carouselIndex === 3) {
                        activeVolBtns[0].style.display = 'none';
                        activeVolBtns[1].style.display = 'none';
                        activeVolBtns[2].textContent = '1 LITRE';
                        activeVolBtns[2].style.display = 'inline-block';
                        volumeIndex = 2; // Force active state onto the right button
                    } else if (carouselIndex === 4) {
                        activeVolBtns[0].textContent = 'CUP NOODLE';
                        activeVolBtns[0].style.display = 'inline-block';
                        activeVolBtns[1].textContent = 'STANDARD';
                        activeVolBtns[1].style.display = 'inline-block';
                        activeVolBtns[2].textContent = 'FAMILY PACK';
                        activeVolBtns[2].style.display = 'inline-block';
                        
                        // Toggle the preloaded foods images
                        const foodsImgs = document.querySelectorAll('.foods-img');
                        if (foodsImgs.length === 3) {
                            foodsImgs.forEach((img, i) => {
                                img.style.display = i === volumeIndex ? 'block' : 'none';
                            });
                        }
                        ...
                        activeVolBtns[1].style.display = 'inline-block';
                        activeVolBtns[2].style.display = 'none';
                        volumeIndex = 1; // Force active state onto the middle button
                    } else {
            ...
            btn.addEventListener('click', (e) => {
                ...
                if (carouselViewportWrapper) {
                    ...
                    if (!isComingSoon) {
                        ...
                        if (catText === 'PREMIUM') carouselIndex = 3;
                        else if (catText === 'FOODS') carouselIndex = 4;
                        else if (catText === 'SODA') carouselIndex = 5;
                        else carouselIndex = 0; // Default to Classic A (slide 0)
        ...
        volBtns.forEach((btn, idx) => {
            btn.addEventListener('click', (e) => {
                ...
                volumeStates[carouselIndex] = idx; // SAVE the state for this slide!
